...
function TableDisplay() {
  return (
    <>
    <h1 style={{textAlign:"center"}}> Pervious tasks had stored in drive</h1>
            ...
            {product.map((element) => {
                return (
                    <tr className="dataTable" >
                        ...
                        <td className="image"><img src={element.image} alt={element.title} style={
                            {
                                width:"200px",
                                height:"200px",
                                textAlign :"center"
                        ...
                        <td className="rating">{element.rating.rate}</td>
                    </tr>
                    )
                }
            )}
